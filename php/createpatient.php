    ...
    if (!empty($_FILES["create-photo"]["tmp_name"]) && is_uploaded_file($_FILES["create-photo"]["tmp_name"])) {
        ...
        if ($uploadOk == 0) {
            ...
            if (move_uploaded_file($_FILES["create-photo"]["tmp_name"], $targetFilePath)) {
                ...
                $sql = "INSERT INTO account_tbl (Email, Name, Password, photo, Account_Type) VALUES ('$Email','$Name','$Password','$uniqueFilename', $Account_type)";
            } else {
        ...
        $sql = "INSERT INTO account_tbl (Email, Name, Password, Photo, Account_Type) VALUES ('$Email','$Name','$Password','$defaultImage', $Account_type)";
    }
